...
// ─── formulário inline de nova cobrança ───────────────────────────────────────
...
function NewBillForm({ onSave, onCancel }: NewBillFormProps) {
  ...
  const handleSave = () => {
    ...
    try {
      ...
      Alert.alert('Valor inválido', 'Use o formato 55,90'); return;
    }
...
const fStyles = StyleSheet.create({
  ...
  cancelBtn: {
    ...
    borderWidth: 1, borderColor: `${Colors.outline}50`,
...
export default function BillsScreen() {
  ...
  // Auto-marca como pago quando hoje >= dia de vencimento
  useEffect(() => {
    autoMarkDue(bills);
  }, []);
